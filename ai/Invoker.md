...
- Planning Mode: Converting finalized design decisions into an actionable ToDoList.
- Execution Mode: Applying code/doc/test changes following the ToDoList steps.
...
3. Coverage confirmation statement (every design requirement mapped to at least one step).
...
- One step = a narrowly scoped change (typically a few minutes, not long involved refactors).
...
## 6. Coverage Verification Procedure
...
## 7. Failure Handling During Execution Mode
...
## 9. Minimal Invocation Algorithm (Planning Mode)
...
5. Decompose into steps; ensure numbering.
...
## 11. Example Abridged Step Pattern
...
- If a step becomes obsolete, exclude it from future tables.

## 13. Lint / Security Exceptions
...
## 14. Exit Criteria (Refactor / Feature Complete)
All tasks show ✅ for every step, coverage mapping shows no gaps, and no open risk notes remain.
...
Both commands must succeed before declaring the ToDoList complete.
