...
// ComposeRotations multiplies two axis-angle rotations: result = a then b.
func ComposeRotations(a, b SFRotation) SFRotation {
	qa := axisAngleToQuat(a)
	qb := axisAngleToQuat(b)
	// Quaternion multiply: qb * qa (apply a first, then b)
	r := [4]float64{
