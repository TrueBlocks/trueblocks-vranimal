...
func (s *Solid) NFaces() int { return s.nFaces }

// NEdges returns the number of edges.
func (s *Solid) NEdges() int { return s.nEdges }

// NVerts returns the number of vertices.
func (s *Solid) NVerts() int { return s.nVerts }
...
func (s *Solid) Stats() (faces, edges, verts int) {
	return s.nFaces, s.nEdges, s.nVerts
}
